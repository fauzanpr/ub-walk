...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description='Run Dijkstra benchmark for FILKOM UB hotspots.')
...
def main() -> None:
    ...
    run_benchmark(
        ...
        solver=dijkstra_json.dijkstra,
        nodes_loader=dijkstra_json.load_nodes,
        edges_loader=dijkstra_json.load_edges,
        nodes_json=args.nodes_json,
        edges_json=args.edges_json,
        report_dir=args.report_dir,
        reference_solver=bellman_ford_json.bellman_ford,
        reference_label='bellman_ford',
    )
