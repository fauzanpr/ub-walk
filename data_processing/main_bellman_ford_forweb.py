...
def main():
    ...
    main_json_path = os.path.join(base, 'main_bellman_ford.py')
    output_path = os.path.join(base, 'output.json')

    print('=== main_bellman_ford_forweb.py DEBUG ===')
    print('BASE DIR:', base)
    ...
    if len(sys.argv) < 3:
        print('Usage: python main_bellman_ford_forweb.py <source_id> <destination_id>')
        sys.exit(1)
    ...
    print('=== STDOUT dari main_bellman_ford.py ===')
    print(process.stdout)

    print('=== STDERR dari main_bellman_ford.py ===')
    print(process.stderr)

    print('RETURN CODE:', process.returncode)

    if process.returncode != 0:
        print('main_bellman_ford.py gagal dijalankan', file=sys.stderr)
